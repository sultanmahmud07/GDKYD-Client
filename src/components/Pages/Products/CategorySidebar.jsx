...
const CategorySidebar = async () => {
    ...
    return (
        <div className="space-y-6">
                        ...
                        return (
                            <li key={i}>
                                <Link
                                    ...
                                    className="group relative flex items-center justify-between px-5 py-3.5 text-gray-600 hover:text-[#064a9b] hover:bg-gray-50 transition-all duration-200"
                                >
                                    {/* Left active indicator line */}
                                    <span className="absolute left-0 top-0 bottom-0 w-[3px] bg-[#064a9b] scale-y-0 group-hover:scale-y-100 transition-transform duration-300 rounded-r-full"></span>
                                    
                                    <span className="text-[15px] font-medium group-hover:translate-x-1 transition-transform duration-200">
                                        {name}
                                    </span>
                                    
                                    <MdKeyboardArrowRight className="text-gray-300 text-lg group-hover:text-[#064a9b] transition-colors" />
                                </Link>
                            </li>
                        );
                    })}
            ...
            {/* 2. Contact Widget - Light & Friendly */}
            {/* Instead of dark BG, we use a subtle blue gradient border/bg */}
            <div className="bg-gradient-to-b from-blue-50/50 to-white rounded-2xl p-6 border border-blue-100 text-center relative overflow-hidden">
                ...
                <div className="flex flex-col gap-3 relative z-10">
                    <a 
                        ...
                        className="flex items-center justify-center gap-2 w-full py-2.5 bg-white border border-gray-200 rounded-xl text-[#064a9b] font-bold text-sm hover:border-[#064a9b] hover:shadow-md transition-all group"
                    >
                    ...
                    <a 
                        ...
                        className="flex items-center justify-center gap-2 w-full py-2.5 bg-[#064a9b] text-white rounded-xl font-bold text-sm shadow-md hover:bg-[#053a7a] hover:shadow-lg transition-all"
                    >
                        <MdEmail />
                        <span>Email Us</span>
                    </a>
